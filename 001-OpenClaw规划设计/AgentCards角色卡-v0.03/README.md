...
4. 部署前必须核对实际 Agent ID、workspace 路径、工具名称、会话可见性、secret profile、状态存储方式和当前 OpenClaw 版本。
5. 不得把角色包中的权限描述当作已经生效；实际限制必须由工具策略、白名单、sandbox、workspace 访问控制和会话可见性实现。
6. 新增或更新角色包时，必须同步仓库根目录 `README.md`、最终设计、工作流程、部署方案和实施路线图中的明确版本路径。
...
- `Workflows工作流程-v0.04.md`
- `DeploymentPlan部署方案-v0.03.md`
- `ImplementationRoadmap实施路线图-v0.03.md`
...
新增前必须完成角色职责、权限边界、隐私范围、授权来源、任务隔离和实际部署能力核对。
