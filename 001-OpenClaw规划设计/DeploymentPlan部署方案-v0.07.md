# 001 OpenClaw架设部署｜DeploymentPlan 部署方案｜v0.07
...
- 賈南風 v1.07：直接回答与正确转交、无工程工具。
- 蕭觀音 v0.04：生活设置唯一所有者、按现有工具真实执行。
- 工程组三角色：职责分离、Review/Risk/Test 不跳过，当前会话记录可先运行。
- 三 companion v0.02：独立直接陪伴、并行、工程权限拒绝。
