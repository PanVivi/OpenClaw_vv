...
- 八个常驻 Agent 均已建立独立目录。
- 当前文件直接位于各 Agent 目录；历史版本进入 `旧文档/<版本>/`。
- 賈南風当前设计版本为 v1.04，蕭觀音当前设计版本为 v0.02。
- 全体 Agent 共同协议当前版本为 v0.02。
- 快速简报、最终设计、部署方案、工作流程、实施路线图、文档规则和根 README 已同步新路径。
...
GitHub 文档中的“当前设计版本”不代表 NAS 已经部署。只有文件、真实权限、Bootstrap、工具调用、消息投递、记忆和自动化全部通过验收后，才能更新当前部署版本。