# 002 OpenClaw架设部署｜CurrentProgress 当前进度｜v0.19
...
- companion-wu 的上述 HTTP 404 是 v0.18 时点历史故障；2026-07-23 本轮复核已恢复 `running=true`、`connected=true`、`restartPending=false`、probe ok。
