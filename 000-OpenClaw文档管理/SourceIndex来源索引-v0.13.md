# 000 OpenClaw文档管理｜SourceIndex 来源索引｜v0.13
...
- 当前进度：`002-OpenClaw部署进度/CurrentProgress当前进度-v0.14.md`
...
`life-automation` 仅向 life 暴露受限生活自动化工具。萧观音直接执行贾南风的正式委派，不依赖 Codex、ops 或管理员在线。
