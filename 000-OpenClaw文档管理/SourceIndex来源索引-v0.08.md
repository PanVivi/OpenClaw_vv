# 000 OpenClaw文档管理｜SourceIndex 来源索引｜v0.08
...
- 当前进度：`002-OpenClaw部署进度/CurrentProgress当前进度-v0.09.md`
- 角色卡库：`001-OpenClaw规划设计/AgentCards角色卡/`
- 共同协议：`001-OpenClaw规划设计/AgentCards角色卡/共同协议/SharedProtocol共同协议.md`
- 角色卡审核：`001-OpenClaw规划设计/RoleCardAudit角色卡审核-v0.05.md`
...
工程基础层可使用当前正式会话内可核对的一次性 Review/Risk 通过记录；专用持久化、目标 Generation 和硬 Gate 属于增强层。
