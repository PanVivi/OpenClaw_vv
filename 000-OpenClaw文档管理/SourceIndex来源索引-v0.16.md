# 000 OpenClaw文档管理｜SourceIndex 来源索引｜v0.16
...
- 当前进度：`002-OpenClaw部署进度/CurrentProgress当前进度-v0.17.md`
...
賈南風 v1.10、蕭觀音 v0.07、魚玄機 v0.11、步非煙 v0.07、夏姬 / reviewer v0.05、三位 companion v0.04。

## 当前部署原则

賈南風负责接单、拆分、异步委派和结果汇总。蕭觀音独立执行生活自动化。魚玄機在正式授权、当前处理权和一次性 Risk 范围内使用 workspace 文件工具及 `mode=auto` 的 NAS Gateway `exec/process` 完成工程配置、服务、部署和 OpenClaw 原生 Telegram 绑定；任意 Gateway、Cron、跨会话历史、技术子 Agent 和任意外发消息仍关闭。
